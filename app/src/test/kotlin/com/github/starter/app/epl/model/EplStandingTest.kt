package com.github.starter.app.epl.model // Updated package declaration

import com.github.starter.modules.epl.model.EplStanding // Import for the actual model
...
class EplStandingTest {
    ...
    fun `EplStanding uses default values when not specified`() {
        val standingDefault = EplStanding(team = "Arsenal") // Only specifying team
    ...
    fun `equals and hashCode work correctly`() {
        ...
        assertEquals(standing1.hashCode(), standing2.hashCode(), "Hash codes for equal EplStanding instances should be the same.")
    }
    ...
    fun `toString returns a string representation`() {
        ...
        assertTrue(standingToString.startsWith("EplStanding("), "toString should start with class name and opening parenthesis.")
