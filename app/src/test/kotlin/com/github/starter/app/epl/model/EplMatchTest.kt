...
import com.github.starter.modules.epl.model.EplMatch // Import for the actual model
...
class EplMatchTest {
    ...
    fun `equals and hashCode work correctly`() {
        ...
        assertEquals(match1.hashCode(), match2.hashCode(), "Hash codes for equal EplMatch instances should be the same.")
    }
    ...
    fun `toString returns a string representation`() {
        ...
        assertTrue(matchToString.startsWith("EplMatch("), "toString should start with class name and opening parenthesis.")
