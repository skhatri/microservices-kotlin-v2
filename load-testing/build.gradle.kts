...
dependencies {
    ...
    implementation("org.scala-lang:scala-compiler:2.13.18")
    implementation("io.gatling:gatling-core:3.15.1")
    implementation("io.gatling:gatling-http:3.15.1")
    implementation("io.gatling:gatling-http-client:3.15.1")
    implementation("io.gatling:gatling-charts:3.15.1")
    implementation("io.gatling:gatling-app:3.15.1")
